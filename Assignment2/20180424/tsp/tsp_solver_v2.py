...
if __name__ == "__main__" :
    ...
    plt.plot(actor_loss_list)
    plt.savefig("C:\CS454\Assignment2\_rl1304(500, 500)/actor_loss.png")
    plt.close("all")

    plt.plot(critic_loss_list)
    plt.savefig("C:\CS454\Assignment2\_rl1304(500, 500)/critic_loss.png")
    plt.close("all")

    plt.plot(reward_list)
    plt.savefig("C:\CS454\Assignment2\_rl1304(500, 500)/reward.png")
    plt.close("all")

    plt.plot(performance_list)
    plt.savefig("C:\CS454\Assignment2\_rl1304(500, 500)/performance.png")
    plt.close("all")
    ...
    best_performance = 100000000
    best_trajectory = [1]
    best_trajectory += list(np.random.permutation(np.arange(2,numberOfNodes+1)))
    best_trajectory += [1]
    ...
    for episode in range(max_episode) :
        ...
        while not done :
            ...
            if random.random() < epsilon :
                action_1, action_2 = [random.randint(2, numberOfNodes), random.randint(2, numberOfNodes)]
            else :
                action_1, action_2 = agent.get_action(state)
    ...
    plt.plot(actor_loss_list)
    plt.savefig("C:\CS454\Assignment2\_rl11849(500, 500)/actor_loss.png")
    plt.close("all")

    plt.plot(critic_loss_list)
    plt.savefig("C:\CS454\Assignment2\_rl11849(500, 500)/critic_loss.png")
    plt.close("all")

    plt.plot(reward_list)
    plt.savefig("C:\CS454\Assignment2\_rl11849(500, 500)/reward.png")
    plt.close("all")

    plt.plot(performance_list)
    plt.savefig("C:\CS454\Assignment2\_rl11849(500, 500)/performance.png")
    plt.close("all")
